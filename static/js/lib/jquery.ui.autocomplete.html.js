...
(function ($) {
    ...
    Autocomplete.prototype = {
        ...
        setOptions: function (suppliedOptions) {
            ...
            if (options.id) {
                $(this.suggestionsContainer).attr('id', options.id);
            }
        },
        ...
        hide: function () {
            ...
            this.el.trigger('auto-suggest-hidden');
        },
        ...
        suggest: function () {
            ...
            var formatResult = this.options.formatResult,
                ...
                suggestionSelector = this.classes.suggestion,
                container = $(this.suggestionsContainer),
                html = '';

            // Build suggestions inner HTML:
            $.each(this.suggestions, function (i, suggestion) {
                html += '<div class="' + suggestionSelector + '" data-index="' + i + '">' + formatResult(suggestion, value) + '</div>';
            });
            ...
            this.el.trigger('auto-suggest-shown', this.response);
        },
